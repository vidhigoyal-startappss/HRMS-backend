...
//   private async sendMail(to: string, subject: string, html: string, attachments?: any[]) {
//     const msg: any = {
//       to,
...
//     `;
//     // };
//   await this.sendMail(email, "Welcome to Startappss HRMS – Your Login Credentials", html);
//   }
//     // try {
