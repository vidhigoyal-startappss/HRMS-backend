...
export class EmailService {
  constructor() {
    ...
    console.log("SendGrid configured with from:", process.env.EMAIL_FROM);
  }
...
<script>
  ...
  document.getElementById('user-name').textContent = userName;
    ...
    await this.sendMail(
      email,
      "Welcome to Startappss HRMS – Your Login Credentials",
      html
    );
  }
 ...
 <div style="font-size: 16px; font-weight: bold; color: #333;">
  ...
  <div style="font-size: 16px; font-weight: bold; color: #333;">
    ...
    try {
      ...
      console.error("Error sending onboarding email via SendGrid:", error);
      throw error;
    }
  }
 ...
 <div style="font-size: 16px; font-weight: bold; color: #333;">
  ...
  `;
    ...
    try {
      const [response] = await sgMail.send(msg);
      console.log(
        `Appointment letter email sent successfully: ${response.statusCode}`
      );
    } catch (error) {
      console.error("Error sending appointment letter via SendGrid:", error);
      throw error;
    }
  }
}
...
//       </html>
//     `;
//     await this.sendMail(email, "HRMS – Password Reset Instructions", html);
...
//       <!DOCTYPE html>
//       <html lang="en">
//       <head><meta charset="UTF-8"><title>Onboarding</title></head>
//       <body>
//         <p>Complete your onboarding process:</p>
//         <a href="${formLink}">Start Onboarding</a>
//       </body>
//       </html>
//     `;
//     await this.sendMail(email, "Complete Your Onboarding Process – Action Required", html);
...
//       <!DOCTYPE html>
//       <html lang="en">
//       <head><meta charset="UTF-8"><title>Appointment Letter</title></head>
//       <body>
//         <p>Please find your appointment letter attached.</p>
//         <a href="${pdfUrl}">Download Appointment Letter</a>
//       </body>
//       </html>
//     `;
//     await this.sendMail(email, "Appointment Letter – Startappss System India Pvt. Ltd.", html);
//     console.log("Appointment letter email sent successfully");
//   }
// }
